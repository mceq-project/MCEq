...
MOCK_MODULES = ['scipy','scipy.optimize','numba','numba']
...
latex_documents = [
  ('index', 'MatrixCascadeEquationMCEq.tex', u'Matrix Cascade Equation (MCEq) Documentation',
...
man_pages = [
    ('index', 'matrixcascadeequationmceq', u'Matrix Cascade Equation (MCEq) Documentation',
...
texinfo_documents = [
  ('index', 'MatrixCascadeEquationMCEq', u'Matrix Cascade Equation (MCEq) Documentation',
   u'Anatoli Fedynitch', 'MatrixCascadeEquationMCEq', 'One line description of project.',
   'Miscellaneous'),
]
