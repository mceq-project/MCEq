...
the separate CUDA driver and the compact-coupling template
(`config.secant_compact_coupling`) are removed. The MKL/CUDA secant kernels
take operators built from `secant_split` (`MCEqRun._secant_kernel_operators`).
