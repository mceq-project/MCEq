    ...
    try:
        ...
        provenance = make_provenance(
            ...
            note=(
                ...
                " operators, production modifiers and DDM. Bug B1 is FIXED"
                " (R3): a neutron primary's isospin copies now land on the"
                " proton's keys, so the _n rows gained the sixth partner key"
                " and K+_n applies 1.45 once, not 1.45^2."
